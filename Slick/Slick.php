<?php
/**
 * Based off \Slim\Slim and \Slick\Slim to extend it, add ability to dynamically create a controller
 * and call an action method on it.
 * Incorporates Psr-11 compatible DI container.
 *
 * Copyright 2014-2015 Rob Allen (rob@akrabat.com).
 * Copyright 2019 Eduard Sukharev (sukharev.eh@gmail.com).
 * License: New-BSD
 */
namespace Slick;
...
class Slick
{
    ...
    {
        list($controllerName, $actionName) = array_filter(explode(':', $name));
     ...
     * @param  string    $name The name of the Slick application
    ...
    /**
     * Set Slick application name
     * @param  string $name The name of this Slick application
     */
    ...
    /**
     * Configure Slick for a given mode
     *
     ...
     * only _after_ you initialize your Slick app.
     *
     * @param  string $mode
     ...
     *
     * The last argument is required and must either be the callable object
     * or controller classname and method string in form "{controller class name}:{action class name}"
     ...
     *
     * If the $callable parameter is null, Slick assumes you want
     ...
     * 2. When invoking the handler:
     *
     * If the $argument parameter is not callable, Slick assumes you want
     * to invoke an already-registered handler. If the handler has been
     ...
     *
     * This method declares the View to be used by the Slick application.
     * If the argument is a string, Slick will instantiate a new object
     * of the same class. If the argument is an instance of View or a subclass
     * of View, Slick will use the argument as the View.
     *
    ...
    /**
     * Get the absolute path to this Slick application's root directory
     *
     * This method returns the absolute path to the Slick application's
     * directory. If the Slick application is installed in a public-accessible
     ...
     * Run
     *
     * This method invokes the middleware stack, including the core Slick application;
